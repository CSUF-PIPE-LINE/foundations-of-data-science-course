...
```{r}
#| label: do this first
here::i_am("Activities/Statistical-Inference-Endoscopy.qmd")
...
```{r}
#| label: explore PACU_LOS by SEDATION_PROVIDER
...
1.  Write a sentence to interpret the confidence interval for $\beta_1$ in the proposed population model.
