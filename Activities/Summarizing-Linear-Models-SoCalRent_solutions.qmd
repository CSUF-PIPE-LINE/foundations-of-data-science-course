...
3. Produce a histogram of the prediction errors (residuals) for the `SoCalRent_test` dataset. Briefly describe the distribution of the residuals. Does this histogram suggest anything concerning about the accuracy of the predictions? Why or why not?
