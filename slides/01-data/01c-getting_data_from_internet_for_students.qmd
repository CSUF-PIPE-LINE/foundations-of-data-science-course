---
title: "Getting Data From the Internet: Student Version"
format: html
editor: visual
execute:
  echo: true
...
# Don't actually run this, the site in req doesn't exist
req |>
  req_perform()
```
...
# I'm not running this in my slides
# You should run this ONCE to get data we'll be using later
# It should give you a 38-39 MB file, so don't keep running it!
req1_la |>
  req_perform(
