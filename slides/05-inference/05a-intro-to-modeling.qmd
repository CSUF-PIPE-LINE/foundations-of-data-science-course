...
```{r}
#| label: simple random sampling-1
#| eval: FALSE
#| echo: TRUE
set.seed(4) 
gas_simple <- gas |>
...
```{r}
#| label: simple random sampling-2
#| eval: TRUE
#| echo: FALSE
...
```{r}
#| label: cluster random sampling-1
#| eval: FALSE
#| echo: TRUE
#| code-line-numbers: "3"
set.seed(125) 
...
```{r}
#| label: cluster random sampling-2
#| eval: TRUE
#| echo: FALSE
